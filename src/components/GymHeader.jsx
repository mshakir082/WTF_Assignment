      ...
      <div className="inputDiv">
        <img src='https://imgs.search.brave.com/6fOTh2mXH3i_BdTZJnuWKuB-Q3i_GQBNvNC4obI5QCg/rs:fit:600:598:1/g:ce/aHR0cHM6Ly93d3cu/Y2xrZXIuY29tL2Ns/aXBhcnRzLzkvVC8y/L2gvWC83L3NlYXJj/aC1pY29uLWhpLnBu/Zw' />
         <input  placeholder="Search gym name here..." />
          <Box cursor={'pointer'} color='white' width='5%'height='80%' mt='3px' ><Image bg='#930809'  borderRadius={'10px'} width='100%' padding='0.6rem 0.9rem' src='https://imgs.search.brave.com/1XkeTeOq2LqG48a2DxciXKldJMpZci7GM4u-yLBSsAw/rs:fit:674:980:1/g:ce/aHR0cHM6Ly93ZWJz/dG9ja3Jldmlldy5u/ZXQvaW1hZ2VzL2Ns/aXBhcnQtbWFwLWxv/Y2F0aW9uLXNpZ24t/MTIucG5n'/></Box>
